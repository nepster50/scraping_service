...
headers = [{'User-Agent': 'Mozilla/5.0 (Windows NT 5.1; rv:47.0) Gecko/20100101 Firefox/47.0',
           ...
           {'User-Agent': 'Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, likeGecko) Chrome/49.0.2623.112 Safari/537.36',
            'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'},
    ...
    if resp.status_code == 200:
        ...
        if main_ul:
            ...
            for li in li_list:
                ...
                content = cont.text
                company = 'No name'
                comp = li.find('div', attrs={'class': 'list-jobs__derails__info'})
                if comp:
                    company = comp.text
                jobs.append({'title': title.text, 'url': domain + href,
                             'description': content, 'company': company})
